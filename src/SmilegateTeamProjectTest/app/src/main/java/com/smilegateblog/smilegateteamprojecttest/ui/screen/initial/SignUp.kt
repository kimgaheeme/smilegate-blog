...
import com.smilegateblog.smilegateteamprojecttest.ui.component.ButtonValue
import com.smilegateblog.smilegateteamprojecttest.ui.component.LoginEditText
import com.smilegateblog.smilegateteamprojecttest.ui.component.SmgButton
...
fun SignUp(onBackClick: () -> Unit) {
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = com.smilegateblog.smilegateteamprojecttest.R.drawable.ic_app_logo),
        ...
        LoginEditText(
            ...
            placeholder = stringResource(id = com.smilegateblog.smilegateteamprojecttest.R.string.initial_email_et),
        ...
        LoginEditText(
            ...
            placeholder = stringResource(id = com.smilegateblog.smilegateteamprojecttest.R.string.initial_password_et),
            onDone = {
        ...
        SmgButton(
            ...
            content = stringResource(id = com.smilegateblog.smilegateteamprojecttest.R.string.signup_create_btn),
